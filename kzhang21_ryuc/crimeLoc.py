...
class crimeLoc(dml.Algorithm):
    ...
    def provenance(doc=prov.model.ProvDocument(), startTime=None, endTime=None):
        ...
        this_script = doc.agent('alg:kzhang21_ryuc#crimeLoc', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        resource = doc.entity('dat:crimeLoc', {'prov:label':'Crime and Station Search', prov.model.PROV_TYPE:'ont:DataResource', 'ont:Extension':'json'})
        ...
        crimeLoc = doc.entity('dat:kzhang21_ryuc#crimeLoc',
                              {prov.model.PROV_LABEL: 'Crime and Station Matching', prov.model.PROV_TYPE: 'ont:DataSet'})
