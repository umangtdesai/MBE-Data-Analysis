...
class crimeNeighborhood(dml.Algorithm):
    contributor = 'gasparde_ljmcgann'
    reads = ['gasparde_ljmcgann.crimes', 'gasparde_ljmcgann.neighborhoods']
    writes = ['gasparde_ljmcgann.crime_grade']
    ...
    def execute(trial=False):
        ...
        for data in crimes.find():
            ...
            print(neighBorhood)
            r = {"_id": data["_id"], "Offense": data["offense_description"], "Neighborhood": neighBorhood,
