...
class fetch(dml.Algorithm):
    contributor = 'simon'
    reads = []
    writes = ['simon.democratic_primary', 'simon.republican_primary', 'simon.greenrainbow_primary', 'simon.mapping']
    ...
    def execute(trial = False):
        ...
        for tag, url in tag_url_list:
            ...
            repo['simon.' + tag].insert_many(json.loads(json_mat))
            repo['simon.' + tag].metadata({'complete': True})
        ...
        repo['simon.mapping'].insert_many(json.loads(json_mat))
        repo['simon.mapping'].metadata({'complete': True})
    ...
    def provenance(doc=prov.model.ProvDocument(), startTime=None, endTime=None):
        ...
        this_script = doc.agent('alg:simon#fetch',
