...
class fetch_data(dml.Algorithm):
    ...
    reads = []
    writes = ['mriver_osagga.bos_neighborhoods', 'mriver_osagga.bos_neighborhoods_income', 'mriver_osagga.bos_neighborhoods_ages', 'mriver_osagga.bos_neighborhoods_education', 'mriver_osagga.bos_311_reqs']
    ...
    def execute(trial = False):
        ...
        r = [ json.loads(json.dumps(d)) for d in csv.DictReader(StringIO(response))]
        ...
        repo['mriver_osagga.bos_neighborhoods_income'].metadata({'complete':True})
        ...
        repo['mriver_osagga.bos_neighborhoods_ages'].metadata({'complete':True})
        ...
        repo['mriver_osagga.bos_neighborhoods_education'].metadata({'complete':True})
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        this_script = doc.agent('alg:mriver_osagga#fetch_data', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        
        resource_1 = doc.entity('bdp:3525b0ee6e6b427f9aab5d0a1d0a1a28_0', {'prov:label':'Boston Neighborhoods', prov.model.PROV_TYPE:'ont:DataResource', 'ont:Extension':'csv'})
        resource_2 = doc.entity('bdp:34f2c48b670d4b43a617b1540f20efe3_0.csv', {'prov:label':'Climate Ready Boston Social Vulnerability', prov.model.PROV_TYPE:'ont:DataResource', 'ont:Extension':'csv'})
        resource_3 = doc.entity('bdp:age', {'prov:label':'Age demographics by neighborhood', prov.model.PROV_TYPE:'ont:DataResource', 'ont:Extension':'csv'})
        resource_4 = doc.entity('bdp:educational-attainment-age-25', {'prov:label':'Educational attainment demographics by neighborhood', prov.model.PROV_TYPE:'ont:DataResource', 'ont:Extension':'csv'})
        resource_5 = doc.entity('bdp:tmpnjyvx2w3', {'prov:label':'311 Service Requests', prov.model.PROV_TYPE:'ont:DataResource', 'ont:Extension':'csv'})

        fetch_data = doc.activity('log:uuid'+str(uuid.uuid4()), startTime, endTime)
        ...
        output_1 = doc.entity('dat:mriver_osagga#bos_neighborhoods', {prov.model.PROV_LABEL:'Boston Neighborhoods', prov.model.PROV_TYPE:'ont:DataSet'})
        output_2 = doc.entity('dat:mriver_osagga#bos_neighborhoods_income', {prov.model.PROV_LABEL:'Income by Neighborhood', prov.model.PROV_TYPE:'ont:DataSet'})
        output_3 = doc.entity('dat:mriver_osagga#bos_neighborhoods_ages', {prov.model.PROV_LABEL:'Age by Neighborhood', prov.model.PROV_TYPE:'ont:DataSet'})
        output_4 = doc.entity('dat:mriver_osagga#bos_neighborhoods_education', {prov.model.PROV_LABEL:'Education by Neighborhood', prov.model.PROV_TYPE:'ont:DataSet'})
        output_5 = doc.entity('dat:mriver_osagga#bos_311_reqs', {prov.model.PROV_LABEL:'311 Service Requests', prov.model.PROV_TYPE:'ont:DataSet'})
        ...
        doc.wasDerivedFrom(output_1, resource_1, fetch_data, fetch_data, fetch_data)
        doc.wasDerivedFrom(output_2, resource_2, fetch_data, fetch_data, fetch_data)
        doc.wasDerivedFrom(output_3, resource_3, fetch_data, fetch_data, fetch_data)
        doc.wasDerivedFrom(output_4, resource_4, fetch_data, fetch_data, fetch_data)
        doc.wasDerivedFrom(output_5, resource_5, fetch_data, fetch_data, fetch_data)
