...
class stateHouseElectionsResults(dml.Algorithm):
    ...
    def provenance(doc=prov.model.ProvDocument(), startTime=None, endTime=None):
        ...
        doc.add_namespace('electionstats_stateHouseElections', ELECTION_DOWNLOAD_RESULTS_URL)
        ...
        resource = doc.entity('electionstats_stateHouseElections:wc8w-nujj', {'prov:label': 'PD43+: Election Stats State House Elections',prov.model.PROV_TYPE: 'ont:DataResource', 'ont:Extension': 'csv'})
        ...
        doc.usage(get_stateHouseElectionsResults, resource, startTime, None,{prov.model.PROV_TYPE: 'ont:Retrieval','ont:Query': 'Election ID'})
