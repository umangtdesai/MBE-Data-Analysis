...
class getBikeFatality(dml.Algorithm):
    ...
    def execute(trial = False):
        ...
        json_file = 'https://data.boston.gov/dataset/d326a4e3-75f2-42ac-9b32-e2920566d04c/resource/92f18923-d4ec-4c17-9405-4e0da63e1d6c/download/fatality_open_data.csv'
