...
class getWaste(dml.Algorithm):
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        doc.add_namespace('bdp', 'https://www.mass.gov/doc/list-of-massachusetts-hazardous-waste-generators-january-15-2019')

        this_script = doc.agent('alg:misn15#waste', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        resource = doc.entity('bdp:Boston_waste', {'prov:label':'Boston_waste', prov.model.PROV_TYPE:'ont:DataResource', 'ont:Extension':'csv'})
        ...
        doc.wasGeneratedBy(waste, get_health, endTime)
