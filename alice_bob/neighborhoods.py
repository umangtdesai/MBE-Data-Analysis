...
class neighborhoods(dml.Algorithm):
    ...
    def execute(trial = False):
        ...
        url = 'hhttp://bostonopendata-boston.opendata.arcgis.com/datasets/3525b0ee6e6b427f9aab5d0a1d0a1a28_0.geojson'
        response = urllib.request.urlopen(url).read().decode("utf-8")
        r = json.loads(response)
        s = json.dumps(r, sort_keys=True, indent=2)
        repo.dropCollection("neighborhoods")
        repo.createCollection("neighborhoods")
        repo['henryhcy_wangyp.neighborhoods'].insert_many(r)
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        resource = doc.entity('bdp:3525b0ee6e6b427f9aab5d0a1d0a1a28_0', {'prov:label':'neighborhoods location', prov.model.PROV_TYPE:'ont:DataResource', 'ont:Extension':'geojson'})
